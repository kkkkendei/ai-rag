...
public class OllamaConfig {
    ...
    @Bean
    public TokenTextSplitter tokenTextSplitter(OllamaApi ollamaApi) {
        return new TokenTextSplitter();
    }

    @Bean
    public SimpleVectorStore simpleVectorStore(@Value("${spring.ai.ollama.base-url}")String model, OllamaApi ollamaApi, OpenAiApi openAiApi) {
